...
def main():
  ...
  for k in range(m):
    ...
    z[0,k] = run(x_train, y_train, x_test, y_test, KNeighborsClassifier(n_neighbors=1))
    z[1,k] = run(x_train, y_train, x_test, y_test, KNeighborsClassifier(n_neighbors=3))
    z[2,k] = run(x_train, y_train, x_test, y_test, KNeighborsClassifier(n_neighbors=5))
    z[3,k] = run(x_train, y_train, x_test, y_test, KNeighborsClassifier(n_neighbors=7))
    z[4,k] = run(x_train, y_train, x_test, y_test, KNeighborsClassifier(n_neighbors=9))
    z[5,k] = run(x_train, y_train, x_test, y_test, KNeighborsClassifier(n_neighbors=11))
    z[6,k] = run(x_train, y_train, x_test, y_test, KNeighborsClassifier(n_neighbors=13))
    z[7,k] = run(x_train, y_train, x_test, y_test, KNeighborsClassifier(n_neighbors=15))

  prettyPrint(z, 0, "KNeighborsClassifier 1")
  prettyPrint(z, 1, "KNeighborsClassifier 3")
  prettyPrint(z, 2, "KNeighborsClassifier 5")
  prettyPrint(z, 3, "KNeighborsClassifier 7")
  prettyPrint(z, 4, "KNeighborsClassifier 9")
  prettyPrint(z, 5, "KNeighborsClassifier 11")
  prettyPrint(z, 6, "KNeighborsClassifier 13")
  prettyPrint(z, 7, "KNeighborsClassifier 15")
